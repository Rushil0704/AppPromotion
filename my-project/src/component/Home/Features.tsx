  ...
  return (
    <div className="pt-16 pb-12">
      <div className="container mx-auto px-4">
        <h2 className="text-center mb-30 font-poppins text-4xl md:text-5xl lg:text-6xl font-bold leading-tight">
          App<span className="text-green-600"> Features</span>
        </h2>

        {/* Features Grid - 2 rows x 3 columns */}
        <div className="grid grid-cols-1 md:grid-cols-3 space-x-6 space-y-20">
